 ...
 * @author Oscar Mendez
 */
public final class reporteDeposito extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CODIGO", "IDCLIENTE", "CUENTA" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 909, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reporteDeposito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new reporteDeposito().setVisible(true);
        });
    }
    ...
    public void filtro() {
        ...
        if (comboFiltro.getSelectedItem() == "IDCLIENTE") {
            columnaABuscar = 1;
        }
        if (comboFiltro.getSelectedItem() == "CUENTA") {
            columnaABuscar = 2;
        }
